...
namespace my_books_shop.Controllers
{
    public class AdminAuthorsController : Controller
    {
        ...
        public AdminAuthorsController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Slug,Image")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Slug,Image")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
